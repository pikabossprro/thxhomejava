        ...
        <div class="main-container d-flex">
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Datos del  Usuario</h1>
                </div>
            </div>
            
            <div class="row mt-3  mb-3 mx-2">
                <div class="col">
                    <a href="usuarioController?accion=?" ><button type="button" class="btn btn-outline-primary" >Volver</button></a>
                </div>
            </div>
               <div class=" row d-flex justify-content-center bg-white mx-2 py-5">
                   <div class="col-xl-10 col-12 col-lg-6 col-md-6" >
                           ...
                           <div class="mb-3 col-xl-12">
                               <h1 class="h2 text-center p-2" >Usuario <span><c:out value="${usuario.nombre}"/></h1>
                           </div>     
                          <div class="mb-3 col-xl-6">
                               <label class="form-label">Nombre :</label>
                               <h1 class="h5 p-2 " ><c:out value="${usuario.nombre}"/></h1>
                           </div>
                           <div class="mb-3 col-xl-6">
                               <label for="apellido" class="form-label">Apellido :</label>
                               <h1 class="h5 p-2 " ><c:out value="${usuario.apellido}"/></h1>
                           </div>
                          <div class="mb-3 col-xl-6">
                               <label for="correo" class="form-label">Correo :</label>
                              <h1 class="h5 p-2 " ><c:out value="${usuario.correo}"/></h1>
                           </div>
                           <div class="mb-3 col-xl-6">
                               <label for="exampleInputPassword1" class="form-label">Contraseña : </label>
                               <h1 class="h5 p-2 " ><c:out value="${usuario.contraseña}"/></h1>
                           </div>
                         <div class="mb-3 col-xl-6">
                               <label for="tipo" class="form-label">Tipo de Usuario : </label>
                               <h1 class="h5 p-2 " ><c:out value="${usuario.tipo_usuario}"/></h1>
                           </div>
                          </div>
                       </form>
                   </div>
