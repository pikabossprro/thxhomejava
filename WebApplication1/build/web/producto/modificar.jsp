        ...
        <div class="main-container d-flex">
            <div class="sidebar" id="side_nav" style="background-color: #398439">
                ...
                <ul class="list-unstyled px-2 mt-5 ">
                    ...
                    <li   class="active " data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent3" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" ><a class="text-decoration-none px-3 py-2 d-block mb-2">Almacen</a>
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Modificar Datos del Producto</h1>
                </div>
            </div>
            
            <div class="row mt-3  mb-3 mx-2">
                <div class="col">
                    <a href="productoController?accion=index" ><button type="button" class="btn btn-outline-primary" >Volver</button></a>
                </div>
            </div>
               <div class="row d-flex justify-content-center  bg-white mx-2 py-5">
                   <div class="  col-xl-10 col-12 col-lg-6 col-md-6 " >
                    <form action="productoController?accion=actualizar" method="POST">
                        <div class="row" >
                            <input type="hidden" name="id" class="form-control" id="id" value="<c:out value="${producto.id_producto}" />"  >
                           <div class="col-xl-6 mb-3">
                               <label for="nombre" class="form-label">Nombre</label>
                               <input type="text" name="nombre" class="form-control" id="nombre" value="<c:out value="${producto.nombre}" />"  >
                           </div>
                          <div class="col-xl-6 mb-3">
                               <label for="codigo" class="form-label">Codigo</label>
                               <input type="text" name="codigo" class="form-control" id="codigo" value="<c:out value="${producto.codigo}" />" >
                           </div> 
                           <div class="col-xl-6 mb-3">
                               <label for="descripcion" class="form-label">Descripcion</label>
                               <input type="text" name="descripcion" class="form-control" id="descripcion" value="<c:out value="${producto.descripcion}" />" >
                           </div> 
                          <div class="col-xl-6 mb-3">
                               <label for="stock" class="form-label">Stock</label>
                               <input  type="text" name="stock" class="form-control col-4" id="stock" value="<c:out value="${producto.stock}" />" >
                           </div>   
                           <div class="col-xl-6 mb-3">
                               <label for="precio" class="form-label">Precio</label>
                               <input  type="text" name="precio" class="form-control col-4" id="Precio" value="<c:out value="${producto.precio}" />" >
                           </div>   
                            <div class="col-xl-6 mb-3 ">
                               <label for="categoria" class="form-label">Categoria</label>
                               <select  name="categoria" class="form-select">
                                 <c:forEach var="categoria" items="${lista}" >
                                     <option value="<c:out  value="${categoria.id_categoria}"/>" ><c:out  value="${categoria.nombre}"/></option>       
                           ...
                           <div class="mb-3 col-xl-6">
                               ...
                               <input type="text"name="imagen" class="form-control" id="imagen" value="<c:out value="${producto.imagen}" />" >
                           </div>
                           <div class="mb-3 col-xl-6">
                               <img src="<c:out value="${producto.imagen}"/>"width="200px" height="220px" alt="alt"/> </td>
                           </div>

                        </div>
                           <input type="submit" class="btn btn-success my-4"value="Actualizar" >
                           <a class="btn btn-danger" href="productoController?accion=index">Cancelar</a>
                       </form>
                   </div>
               </div>
