        ...
        <div class="main-container d-flex">
           ...
           <div class="container ">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Gestion de Productos</h1>
                </div>
            </div>
            
            <div class="row mt-3  mb-3">
                <div class="col">
                    <a href="productoController?accion=nuevo"><button type="button" class="btn btn-outline-danger" ><i class="fa-sharp fa-solid fa-plus"></i>Agregar</button></a>
                </div>
            </div>
                             ...
                             <tbody>
                                 <c:forEach var="producto" items="${lista}">
                                     <tr>
                                         ...
                                         <td><img src="<c:out value="${producto.imagen}"/>"width="100px" height="90px" alt="alt"/> </td>
                                         <td> <a class='btn btn-primary' href="productoController?accion=ver&id=<c:out value="${producto.id_producto}"/>"><i class="fa-solid fa-eye"></i></a> <a class='btn btn-secondary' href="productoController?accion=modificar&id=<c:out value="${producto.id_producto}"/>"><i class="fa-regular fa-pen-to-square"></i></a> <a class='btn btn-danger' href="productoController?accion=eliminar&id=<c:out value="${producto.id_producto}"/>"><i class="fa-solid fa-trash"></i></a></td>
                                     </tr>
                                 </c:forEach>    
                             </tbody>
                         </table>
