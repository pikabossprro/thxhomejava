        ...
        <div class="main-container d-flex">
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Gestion de Ingresos de Productos</h1>
                </div>
            </div>
            
            <div class="row mt-3  mb-3">
                <div class="col">
                    <a href="ingresoController?accion=nuevo"><button type="button" class="btn btn-outline-danger" ><i class="fa-sharp fa-solid fa-plus"></i>Nuevo Ingreso</button></a>
                </div>
            </div>
               <div class="row bg-white p-4 ">
                   <div class="col">
                         <table id="datatable" class="table table-striped table-bordered nowrap py-2" style="width:100%"  >
                             ...
                             <tbody>
                                 <c:forEach var="ingreso" items="${lista}">
                                     <tr>
                                         <td><c:out value="${ingreso.id_ingreso}"/></td>
                                         <td><c:out value="${ingreso.ruc}"/></td>
                                         <td><c:out value="${ingreso.proveedor}" /></td>
                                         <td><c:out value="${ingreso.codigo_producto}" /></td>
                                         <td><c:out value="${ingreso.producto}" /></td>
                                         <td><c:out value="${ingreso.cantidad}" /></td>
                                         <td><c:out value="${ingreso.fecha}"/></td>
                                          <td><c:out value="${ingreso.precio_compra}"/></td>
                                          <td><c:out value="${ingreso.precio_venta}"/></td>
                                          <td><c:out value="${ingreso.sub_total}"/></td>
                                         <td> 
                                             <a class='btn btn-secondary' href="ingresoController?accion=modificar&id=<c:out value="${ingreso.id_ingreso}"/>"><i class="fa-regular fa-pen-to-square"></i></a> <a class='btn btn-danger' name="eliminar" href="ingresoController?accion=eliminar&id=<c:out value="${ingreso.id_ingreso}"/>"><i class="fa-solid fa-trash"></i></a></td>
                                     </tr>
                                 </c:forEach>    
                             </tbody>
                         </table>
