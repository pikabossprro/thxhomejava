        ...
        <div class="main-container d-flex">
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Gestión de Categorías de los Productos</h1>
                </div>
            </div>
            
            <div class="row mt-3  mb-3">
                <div class="col">
                    <a href="categoriaController?accion=nuevo"><button type="button" class="btn btn-outline-primary" >Añadir categoría</button></a>
                </div>
            </div>
                             ...
                             <tbody>
                                 <c:forEach var="categoria" items="${lista}">
                                     <tr>
                                         ...
                                         <td> <a class='btn btn-primary' href="categoriaController?accion=ver&id=<c:out value="${categoria.id_categoria}"/>"><i class="fa-solid fa-eye"></i></a> <a class='btn btn-secondary' href="categoriaController?accion=modificar&id=<c:out value="${categoria.id_categoria}"/>"><i class="fa-regular fa-pen-to-square"></i></a> <a class='btn btn-danger' href="categoriaController?accion=eliminar&id=<c:out value="${categoria.id_categoria}"/>"><i class="fa-solid fa-trash"></i></a></td>
                                     </tr>
                                 </c:forEach>    
                             </tbody>
                         </table>
