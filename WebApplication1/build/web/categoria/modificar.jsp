        ...
        <div class="main-container d-flex">
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Modificar Datos de la Categoría</h1>
                </div>
            </div>
            
            <div class="row mt-3  mb-3 mx-2">
                <div class="col">
                    <a href="categoriaController?accion=index" class="btn btn-outline-primary" >Volver</a>
                </div>
            </div>
               <div class="row d-flex justify-content-center  bg-white mx-2 py-5">
                   <div class="  col-xl-10 col-12 col-lg-6 col-md-6 " >
                    <form action="categoriaController?accion=actualizar" method="POST">
                        <div class="row" >
                            <input type="hidden" name="id" class="form-control" value="<c:out value="${categoria.id_categoria}"/>" >
                           <div class="col-xl-6 mb-3">
                               <label for="nombre" class="form-label">Nombre</label>
                               <input type="text" name="nombre" class="form-control" id="nombre" value="<c:out value="${categoria.nombre}"/>" >
                           </div>
                          <div class="col-xl-6 mb-3">
                               <label for="descripcion" class="form-label">Descripcion</label>
                               <textarea  name="descripcion" rows="5" cols="40" class="form-control" id="descripcion" ><c:out value="${categoria.descripcion}"/></textarea>
                           </div>       
                        </div>
                           <input type="submit" class="btn btn-success my-4"value="Actualizar" >
                           <a class="btn btn-danger" href="categoriaController?accion=index">Cancelar</a>
                       </form>
                   </div>
               </div>
