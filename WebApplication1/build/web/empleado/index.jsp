        ...
        <div class="main-container d-flex">
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Gestión de Empleados de la Tienda</h1>
                </div>
            </div>
            
            <div class="row mt-3  mb-3">
                <div class="col">
                    <a href="empleadoController?accion=nuevo"><button type="button" class="btn btn-outline-danger" ><i class="fa-sharp fa-solid fa-plus"></i>Agregar</button></a>
                </div>
            </div>
               <div class="row bg-white p-4 ">
                   <div class="col">
                         <table id="datatable" class="table table-striped table-bordered nowrap py-2" style="width:100%"  >
                             <thead style="background-color: 2C3153" class="text-white">
                                 <tr>
                                     <th scope="col">Id</th>
                             ...
                             <tbody>
                                 <c:forEach var="empleado" items="${lista}">
                                     <tr>
                                         ...
                                         <td> <a class='btn btn-primary' href="empleadoController?accion=ver&id=<c:out value="${empleado.id_empleado}"/>"><i class="fa-solid fa-eye"></i></a> <a class='btn btn-secondary' href="empleadoController?accion=modificar&id=<c:out value="${empleado.id_empleado}"/>"><i class="fa-regular fa-pen-to-square"></i></a> <a class='btn btn-danger' name="eliminar" href="empleadoController?accion=eliminar&id=<c:out value="${empleado.id_empleado}"/>"><i class="fa-solid fa-trash"></i></a></td>
                                     </tr>
                                 </c:forEach>    
                             </tbody>
                         </table>
