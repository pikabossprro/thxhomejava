                    ...
                    <form action="empleadoController?accion=actualizar" class="p-2" method="POST">
                        ...
                        <div  class="mb-3 col-xl-6">
                               <label for="apellido" class="form-label">Apellido</label>
                                <h1 class="h5 p-2 " ><c:out value="${empleado.apellido}"/></h1>
                         </div>
                         <div class="mb-3 col-xl-6">
                               <label for="nombre" class="form-label">Nombre</label>
                                <h1 class="h5 p-2 " ><c:out value="${empleado.nombre}"/></h1>
                         </div> 
                          <div class="mb-3 col-xl-6">
                               <label for="dni" class="form-label">Dni:</label>
                                <h1 class="h5 p-2 " ><c:out value="${empleado.dni}"/></h1>
                           </div>
                           
                            <div class="mb-3 col-xl-6">
                               <label for="correo" class="form-label">Correo</label>
                                <h1 class="h5 p-2 " ><c:out value="${empleado.email}"/></h1>
                           </div>
                           
                           
                            <div class="mb-3 col-xl-6">
                               <label for="telefono" class="form-label">Telefono</label>
                                <h1 class="h5 p-2 " ><c:out value="${empleado.telefono}"/></h1>
                           </div>
                            
                           <div class="mb-3 col-xl-6">
                               <label class="form-label">Fecha de Nacimiento</label>
                                <h1 class="h5 p-2 " ><c:out value="${empleado.fecha_nacimiento}"/></h1>
                           </div>
                           
                          <div class="mb-3 col-xl-6">
                               <label  class="form-label">Direccion</label>
                                <h1 class="h5 p-2 " ><c:out value="${empleado.direccion}"/></h1>
                           </div>
                          <div class="mb-3 col-xl-6">
                               <label class="form-label">Cargo</label>
                               <h1 class="h5 p-2 " ><c:out value="${empleado.cargo}"/></h1>
                           </div>  
