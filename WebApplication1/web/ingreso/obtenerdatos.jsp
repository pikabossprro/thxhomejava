...
<head>
 ...
 <body>
          ...
          {
                String ruc,nombrepro;
                ruc=request.getParameter("ruc");
                nombrepro=request.getParameter("nombrepro");
                out.print(nombrepro);
        ...
        <div class="main-container d-flex">
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Registro de nueva Compra</h1>
                </div>
            </div>
            ...
            <div class="row mt-3  mb-3 mx-2">
               ...
               <div class="row d-flex justify-content-center   ">       
                   <div class="  col-xl-12 col-12 col-lg-12 col-md-12 " >
                    <form action="ingresoController?accion=insertar"  method="POST">                       
                          ...
                          <div class="col-xl-12 mb-3 ">
                               <div class="row">     
                                  <h1 class="fs-6 text-danger" >Detalle de Proveedor</h1>
                                   <div class="col-xl-4">
                                       <label for="ruc" class="form-label"  >Codigo</label>
                                       <input type="text" name="ruc"  value="<c:out value="${proveedor.ruc}" />"  onkeyup="mostar()"   class="form-control" id="ruc" readonly >
                                   </div>
                               <div class="col-xl-4">
                               ...
                               <div class="col-xl-4 text-center mt-3 ">
                                       <button type="button" class="btn btn-success mt-3" data-bs-toggle="modal" data-bs-target="#exampleModal1" disabled >
 <i class="fa-solid fa-magnifying-glass"></i> Buscar
                           ...
                           <div class="col-xl-12 mb-3 py-5">
                               ...
                               <div class="col-xl-2">
                                    ...
                                    <input type="text" name="codigo" class="form-control"  value="<c:out value="${producto.codigo}" />" id="codigo" >
                               </div>
                               <div class="col-xl-2">
                                    <label for="nombre" class="form-label">Producto</label>
                                    <input type="text" name="nombre" class="form-control"  value="<c:out value="${producto.nombre}" />"  id="nombre"  >
                               </div>
                                <div class="col-xl-2">
                                ...
                                <div class="col-xl-2">
                                    ...
                                    <input type="text" name="pcompra" class="form-control"   id="pcompra" >
                               </div>
                               <div class="col-xl-2">
                                    <label for="pventa" class="form-label">Prec. venta <span class="text-danger" >S./0.00 </span></label>
                                    <input type="text" name="pventa" class="form-control"    id="pventa" >
                               </div>
                         ...
                         <div class="col-12 text-end" >
                               <button type="submit" class="btn btn-success my-4 text-start"  value="Registrar" ><i class="fa-regular fa-file fs-5"></i> Guardar compra</button>
