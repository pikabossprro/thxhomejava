        ...
        <div class="main-container d-flex">
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Modificar Producto Ingresado</h1>
                </div>
            </div>
            ...
            <div class="row mt-3  mb-3 mx-2">
               ...
               <div class="row d-flex justify-content-center   ">       
                   <div class="  col-xl-12 col-12 col-lg-12 col-md-12 " >
                    <form action="ingresoController?accion=actualizar"  method="POST">                       
                        <div class="row p-5 bg-white" >
                                                          
                          <div class="col-xl-12 mb-3 ">
                               <div class="row">     
                                  <h1 class="fs-6 text-danger" >Detalle de Proveedor</h1>
                                   <input type="hidden" name="id" value="<c:out value="${ingreso.id_ingreso}" />"  class="form-control" id="ruc"  >
                                   <div class="col-xl-4">
                                       <label for="ruc" class="form-label">Ruc</label>
                                       <input type="text" name="ruc" value="<c:out value="${ingreso.ruc}" />"  class="form-control" id="ruc" readonly >
                                   </div>
                               <div class="col-xl-4">
                                    <label for="nombrepro" class="form-label">Razon Social</label>
                                    <input type="text" name="nombrepro"  value="<c:out value="${ingreso.proveedor}" />"  class="form-control" id="nombrepro" readonly >
                               </div>
                           ...
                           <div class="col-xl-12 py-5">
                               ...
                               <div class="col-xl-2">
                                    ...
                                    <input type="text" name="codigo" value="<c:out value="${ingreso.codigo_producto}" />" class="form-control"   id="codigo" >
                               </div>
                               <div class="col-xl-2">
                                    <label for="nombre" class="form-label">Producto</label>
                                    <input type="text" name="nombre" value="<c:out value="${ingreso.producto}" />" class="form-control"  id="nombre" >
                               </div>
                               <div class="col-xl-2">
                                    <label for="fecha" class="form-labe">Fecha</label>
                                    <input type="date" name="fecha" value="<c:out value="${ingreso.fecha}" />" class="form-control"   id="fecha" >
                               </div>
                                <div class="col-xl-2">
                                    <label for="cantidad" class="form-labe"  >Cantidad</label>
                                    <input type="text" name="cantidad"  value="<c:out value="${ingreso.cantidad}" />" class="form-control"   id="cantidad" >
                               </div>
                               
                                <div class="col-xl-2">
                                    <label for="pcompra" class="form-labe">Prec. compra <span class="text-danger" >S./0.00 </span></label>
                                    <input type="text" name="pcompra"  class="form-control"  value="<c:out value="${ingreso.precio_compra}" />" id="pcompra" >
                               </div>
                               <div class="col-xl-2">
                                    <label for="pventa" class="form-label">Prec. venta <span class="text-danger" >S./0.00 </span></label>
                                    <input type="text" name="pventa"  class="form-control" value="<c:out value="${ingreso.precio_venta}" />"    id="pventa" >
                               </div>
                         ...
                         <div class="col-12 text-end" >
                               <button type="submit" class="btn btn-success my-4 text-start" name="registrar"  ><i class="fa-regular fa-file fs-5"></i> Actualizar</button>
                               <a class="btn btn-danger" href="ingresoController?accion=index">Cancelar</a>
                        </div>
                   </div>   
                    </form>
                   </div>
