        ...
        <div class="main-container d-flex">
            <div class="sidebar" id="side_nav" style="background-color: #398439">
                ...
                <ul class="list-unstyled px-2 mt-5 ">
                    ...
                    <ul class=" list-unstyled collapse navbar-collaps" id="navbarSupportedContent3"  >
                        ...
                        <li class="nav-item" > <a class="text-decoration-none px-5 py-2 d-block" href="productoControllerr?accion=index">Categorias</a></li>
                    </ul>
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Modificar Datos de Usuario</h1>
                </div>
            </div>
            ...
            <div class="row mt-3  mb-3 mx-2">
               ...
               <div class=" row d-flex justify-content-center bg-white bg-white mx-2 py-5 my-4 ">
                   <div class="col-xl-10 col-12 col-lg-6 col-md-6" >
                           <form action="usuarioController?accion=actualizar" method="POST">
                               <div class="row">
                               <input type="hidden" name="id" class="form-control" id="id" value="<c:out value="${usuario.id_usuario}"/>" >

                           <div class="mb-3 col-xl-12">
                               <h1 class="h2 text-center p-2" >Usuario <span></span> <c:out value="${usuario.nombre}"/></h1>
                           </div>     
                           <div class="mb-3 col-xl-6">
                               <label for="nombre" class="form-label">Nombre</label>
                               <input type="text" name="nombre" class="form-control" id="nombre" value="<c:out value="${usuario.nombre}"/>" readonly >
                           </div>
                           <div class="mb-3 col-xl-6">
                               <label for="apellido" class="form-label">Apellido</label>
                               <input type="text" name="apellido" class="form-control" id="apellido"  value="<c:out value="${usuario.apellido}"/>" readonly >
                           </div>
                          <div class="mb-3 col-xl-6">
                               <label for="correo" class="form-label">Correo</label>
                               <input type="text" name="correo" class="form-control" id="correo"  value="<c:out value="${usuario.correo}"/>" readonly>
                           </div>
                           <div class="mb-3 col-xl-6">
                               <label for="exampleInputPassword1" class="form-label">Contraseña</label>
                               <input type="text"name="clave" class="form-control" id="exampleInputPassword1"  value="<c:out value="${usuario.contraseña}"/>" >
                           </div>
                         <div class="mb-3 col-xl-6">
