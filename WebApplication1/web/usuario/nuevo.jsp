            ...
            <div class="row mt-3  mb-3 mx-2">
               ...
               <div class="row d-flex justify-content-center bg-white mx-2 py-5">
                   <div class="col-xl-10 col-12 col-lg-6 col-md-6" >
                           <form action="usuarioController?accion=act_datos"class="p-2" method="POST">
                              
                          <div class="row">
                           <div class="mb-4 col-xl-12">                                              
                               
                               <h1 for="nombre" class="h5 mb-4">Buscar Empleados : </h1>
                                  
                               <select class="form-select" name="id" aria-label="Default select example" >
                                   <option></option>
                                 <c:forEach var="empleado" items="${lista}">
                                     <option value="<c:out value="${empleado.id_empleado}"/>"><c:out value="${empleado.apellido} ${empleado.nombre}"/></option>
                                 </c:forEach>    
                            </select>
