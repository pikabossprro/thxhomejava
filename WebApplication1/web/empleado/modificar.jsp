        ...
        <div class="main-container d-flex">
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Modificar Datos del Empleado </h1>
                </div>
            </div>
            
            <div class="row mt-3  mb-3 mx-2">
                <div class="col">
                    <a href="empleadoController?accion=index" ><button type="button" class="btn btn-outline-primary" >Volver</button></a>
                </div>
            </div>
               <div class="row d-flex justify-content-center  bg-white mx-2 py-5 my-4 ">
                   <div class=" col-xl-10 col-12 col-lg-6 col-md-6" >
                    <form action="empleadoController?accion=actualizar" class="p-2" method="POST">
                        <div class="row">
                          <div class="mb-3 col-xl-12 text-center ">
                             <input type="hidden" name="id" class="form-control"  value="<c:out value="${empleado.id_empleado}"/>" >
                             <h1 class="h2  p-2" >Empleado <span></span> <c:out value="${empleado.nombre}"/></h1>
                           </div>
                            <div  class="mb-3 col-xl-6">
                               <label for="apellido" class="form-label">Apellido</label>
                               <input type="text" name="apellido" class="form-control" id="apellido" value="<c:out value="${empleado.apellido}"/>" >
                           </div>
                           
                           <div class="mb-3 col-xl-6">
                               <label for="nombre" class="form-label">Nombre</label>
                               <input type="text" name="nombre" class="form-control" id="nombre" value="<c:out value="${empleado.nombre}"/>">
                           </div>
                           <div class="mb-3 col-xl-6">
                               <label for="dni" class="form-label">Dni:</label>
                               <input type="text" name="dni" class="form-control" id="dni" value="<c:out value="${empleado.dni}"/>">
                           </div>
                           
                           <div class="mb-3 col-xl-6">
                               <label for="correo" class="form-label">Correo</label>
                               <input type="text" name="correo" class="form-control" id="correo" value="<c:out value="${empleado.email}"/>" >
                           </div>
                           <div class="mb-3 col-xl-6">
                               <label for="telefono" class="form-label">Telefono</label>
                               <input type="text"name="telefono" class="form-control" id="telefono"value="<c:out value="${empleado.telefono}"/>">
                           </div> 
                           <div class="mb-3 col-xl-6">
                               <label for="fecha_nacimiento" class="form-label">Fecha de Nacimiento</label>
                               <input type="date"name="fecha_nacimiento" class="form-control" id="fecha_nacimiento" value="<c:out value="${empleado.fecha_nacimiento}"/>">
                           </div>
                           
                          <div class="mb-3 col-xl-6">
                               <label for="direccion" class="form-label">Direccion</label>
                               <input type="text"name="direccion" class="form-control" id="direccion" value="<c:out value="${empleado.direccion}"/>">
                           </div>
                           <div class="mb-3 col-xl-6">
                               <label class="form-label">Cargo </label>
                             <select  name="cargo" class="form-select">
                                    
                                     <c:forEach var="cargos" items="${lista}">
                                          <option value="<c:out  value="${cargos.id_cargo}"/>" ><c:out  value="${cargos.nombre}"/></option>
                                     </c:forEach>
                               </select>
                           </div>
                        </div>
                           ...
                           <a class="btn btn-danger" href="empleadoController?accion=index">Cancelar</a>
                       </form>
                   </div>
               </div>
