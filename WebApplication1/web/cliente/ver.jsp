                    ...
                    <form action="clienteController?accion=actualizar" method="POST">
                        <div class="row" >
                           ...
                           <div class="col-xl-6 mb-3">
                               ...
                               <h1 class="fs-5"><c:out  value="${cliente.apellido}" /></h1>
                           </div>
                          <div class="col-xl-6 mb-3">
                               <label for="nombre" class="form-label">Nombre</label>
                             <h1 class="fs-5"><c:out  value="${cliente.nombre}" /></h1>
                           </div>  
                            <div class="col-xl-6 mb-3 ">
                               <label for="correo" class="form-label">Correo</label>
                               <h1 class="fs-5"><c:out  value="${cliente.email}" /></h1>
                           </div>                               
                           <div class="mb-3 col-xl-6">                       
                   
                               <label for="clave" class="form-label " >Contraseña</label>
                               <h1 class="fs-5"><c:out  value="${cliente.contraseña}" /></h1>
                           </div>
                              
                           <div class="mb-3 col-xl-6">
                               <label class="form-label">Telefono</label>
                               <h1 class="fs-5"><c:out  value="${cliente.telefono}" /></h1>
                           </div>               
                        </div>
