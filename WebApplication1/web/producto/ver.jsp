        ...
        <div class="main-container d-flex">
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Datos del Producto</h1>
                </div>
            </div>
                    ...
                    <form action="productoController?accion=actualizar" method="POST">
                        <div class="row" >
                           ...
                           <div class="col-xl-6 mb-3">
                               ...
                               <h1 class="h5" ><c:out value="${producto.nombre}" /></h1>
                           </div>
                          <div class="col-xl-6 mb-3">
                               <label for="codigo" class="form-label">Codigo</label>
                               <h1 class="h5" ><c:out value="${producto.codigo}" /></h1>
                           </div> 
                           <div class="col-xl-6 mb-3">
                               <label for="descripcion" class="form-label">Descripcion</label>
                               <h1 class="h5" ><c:out value="${producto.descripcion}" /></h1>
                           </div> 
                          <div class="col-xl-6 mb-3">
                               <label for="stock" class="form-label">Stock</label>
                               <h1 class="h5" ><c:out value="${producto.stock}" /></h1>
                           </div>   
                           <div class="col-xl-6 mb-3 ">
                               <label for="precio" class="form-label">Precio</label>
                               <h1 class="h5" ><c:out value="${producto.precio}" /></h1>
                           </div>  
                            <div class="col-xl-6 mb-3 ">
                               <label for="categoria" class="form-label">Categoria</label>
                               <h1 class="h5" ><c:out value="${producto.categoria}" /></h1>
                           </div>   
                           <div class="mb-3 col-xl-6">
                               <label for="imagen" class="form-label">Imagen URL:</label>
                               <img src="<c:out value="${producto.imagen}" />" width="200px" height="190px" alt="alt"/>
                           </div>
