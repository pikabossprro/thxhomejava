        ...
        <div class="main-container d-flex">
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Datos del Proveedor</h1>
                </div>
            </div>
                    ...
                    <form action="proveedorController?accion=actualizar" method="POST">
                        <div class="row" >
                           ...
                           <div class="col-xl-6 mb-3">
                              ...
                              <h1 class="fs-5"><c:out value="${proveedor.nombre}"/></h1>
                           </div>
                          <div class="col-xl-6 mb-3">
                               <label for="ruc" class="form-label">Ruc</label>
                               <h1 class="fs-5"><c:out value="${proveedor.ruc}"/></h1>
                           </div> 
                           <div class="col-xl-6 mb-3">
                               <label for="correo" class="form-label">correo</label>
                               <h1 class="fs-5"><c:out value="${proveedor.email}"/></h1>
                           </div> 
                          <div class="col-xl-6 mb-3">
                               <label for="direccion" class="form-label">Direccion</label>
                               <h1 class="fs-5"><c:out value="${proveedor.direccion}"/></h1>
                           </div>   
                           <div class="col-xl-6 mb-3">
                               <label  class="form-label">Telefono</label>
                               <h1 class="fs-5"><c:out value="${proveedor.telefono}"/></h1>
                           </div>   
                        </div>
                       </form>
                   </div>
