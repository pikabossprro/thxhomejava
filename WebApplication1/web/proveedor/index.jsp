        ...
        <div class="main-container d-flex">
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Gestion de Proveedores</h1>
                </div>
            </div>
            
            <div class="row mt-3  mb-3">
                <div class="col">
                    <a href="proveedorController?accion=nuevo"><button type="button" class="btn btn-outline-danger" ><i class="fa-sharp fa-solid fa-plus"></i>Agregar</button></a>
                </div>
            </div>
                             ...
                             <tbody>
                                 <c:forEach var="proveedor" items="${lista}">
                                     <tr>
                                         ...
                                         <td> <a class='btn btn-primary' href="proveedorController?accion=ver&id=<c:out value="${proveedor.id_proveedor}"/>">
                                                 <i class="fa-solid fa-eye"></i></a> <a class='btn btn-secondary' href="proveedorController?accion=modificar&id=<c:out value="${proveedor.id_proveedor}"/>"><i class="fa-regular fa-pen-to-square"></i></a> <a class='btn btn-danger' name="eliminar" href="proveedorController?accion=eliminar&id=<c:out value="${proveedor.id_proveedor}"/>"><i class="fa-solid fa-trash"></i></a></td>
                                     </tr>
                                 </c:forEach>    
                             </tbody>
                         </table>
