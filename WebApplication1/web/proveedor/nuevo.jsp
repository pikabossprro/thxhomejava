        ...
        <div class="main-container d-flex">
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Registrar Nuevo Proveedor</h1>
                </div>
            </div>
            ...
            <div class="row mt-3  mb-3 mx-2">
               ...
               <div class="row d-flex justify-content-center  bg-white mx-2 py-5">
                   <div class="  col-xl-10 col-12 col-lg-6 col-md-6 " >
                    <form action="proveedorController?accion=insertar" method="POST">
                        <div class="row" >
                          ...
                          <div class="col-xl-6 mb-3">
                               ...
                               <input  type="text" name="direccion" class="form-control col-4" id="direccion">
                           </div>   
                           <div class="col-xl-6 mb-3">
                               <label for="telefono" class="form-label">Telefono</label>
                               <input  type="text" name="telefono" class="form-control col-4" id="telefono" >
                           </div>   
                        </div>
