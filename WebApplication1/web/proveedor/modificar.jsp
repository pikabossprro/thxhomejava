        ...
        <div class="main-container d-flex">
           ...
           <div class="container">
            <div class="row bg-dark">
                <div class="col">
                    <h1 class="text-white" >Modificar Datos de Proveedor</h1>
                </div>
            </div>

            <div class="row mt-3  mb-3 mx-2">
                <div class="col">
                    <a href="proveedorController?accion=index" ><button type="button" class="btn btn-outline-primary" >Volver</button></a>
                </div>
            </div>
               <div class="row d-flex justify-content-center  bg-white mx-2 py-5">
                   <div class="  col-xl-10 col-12 col-lg-6 col-md-6 " >
                    <form action="proveedorController?accion=actualizar" method="POST">
                        <div class="row" >
                               <input type="hidden" name="id" class="form-control" value="<c:out value="${proveedor.id_proveedor}"/>"  id="nombre">
                           <div class="col-xl-6 mb-3">
                               <label for="nombre" class="form-label">Razon Social</label>
                               <input type="text" name="nombre" class="form-control" value="<c:out value="${proveedor.nombre}"/>"   id="nombre">
                           </div>
                          <div class="col-xl-6 mb-3">
                               <label for="ruc" class="form-label">Ruc</label>
                               <input type="text" name="ruc" class="form-control" value="<c:out value="${proveedor.ruc}"/>" id="ruc">
                           </div> 
                           <div class="col-xl-6 mb-3">
                               <label for="correo" class="form-label">correo</label>
                               <input type="text" name="correo" class="form-control" value="<c:out value="${proveedor.email}"/>" id="correo">
                           </div> 
                          <div class="col-xl-6 mb-3">
                               <label for="direccion" class="form-label">Direccion</label>
                               <input  type="text" name="direccion" class="form-control col-4" value="<c:out value="${proveedor.direccion}"/>" id="direccion">
                           </div>   
                           <div class="col-xl-6 mb-3">
                               <label for="telefono" class="form-label">Telefono</label>
                               <input  type="text" name="telefono" class="form-control col-4"  value="<c:out value="${proveedor.telefono}"/>"   id="telefono" >
                           </div>   
                        </div>
