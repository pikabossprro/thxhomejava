            ...
            <div class="container">
                ...
                <div id="responsive-nav">
                    ...
                    <ul class="main-nav nav navbar-nav">
                        ...
                        <li  class="active"><a >Carrito</a></li>
                    </ul>
                    <!-- /NAV -->
                </div>
                <!-- /responsive-nav -->
                       ...
                       %>
                            <tr>
                               ...
                               <td><%=c.getItem() %></td>
                                <td><%=c.getNombre() %></td>
                                <td><%=c.getDescripcion() %>                               
                                       <img src="<%=c.getImagen() %> " width="120px" >
                                </td>
                                <td><%=c.getPrecio_compra()%></td>
                                <td><%=c.getCantidad() %></td>
                                <td><%=c.getSub_total() %></td>
                                <td>
                                    <a href="carritoController?accion=eliminar&id=<%=c.getId_producto() %>" class="btn btn-danger" >Eliminar</a>
                                </td>
                            </tr>
           <%}%>
                        </tbody>
                    ...
                    <div class="card">
                       ...
                       <div class="card-header">
                        ...
                        <div class="card-body py-4">
                            <label class="form-labe" >Sub total :</label>
                            <input type="text" value=" S/. <c:out value="${totalpagar}0" />" readonly class="form-control" >
                             
                            <label class="form-labe" >Total a Pagar </label>
                            <input type="text" value=" S/. <c:out value="${totalpagar}0" />" readonly class="form-control" >
                            
                        </div>
                        <div class="card-footer">
                            <br>
                            <a href="carritoController?accion=rcompra" class="btn btn-success btn-block" >Realizar Compra</a>
                        </div>
                    </div>
                            <br><br><br><br>
                </div>
