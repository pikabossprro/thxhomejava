...
<html lang="es">
    ...
    <body>
            ...
            <div id="top-header">
                <div class="container">
                    <ul class="header-links pull-left">
                        ...
                        <li><a href="#"><i class="fa fa-envelope-o"></i> thxhome@gmail.com</a></li>
                                    ...
                                    <% 
                                        ...
                                        if (sesiontienda.getAttribute("logueado")== null || sesiontienda.getAttribute("logueado").equals("0")){
                                             out.print("<a href='tiendaloginController?accion=login' class='btn btn-success'> Iniciar Sesion </a>");                                 
                                                ...
                                                out.print("<a type='submit' class='btn btn-danger' href='tiendaindexController?accion=index'>Cerrar sesion </a> "
                                                );
        ...
        <p   style="font-size:40px; " >Gracias por tu compra , puedes visualizar tus compras en "Mis pedidos"</p><i class="fa-thin fa-party-horn"></i>
        <a style="font-size:25px; " href="tiendaindexController?accion=index"   >Seguir Comprando </a>
     </div>
        <br>
        <!-- FOOTER -->
        <footer id="footer">
